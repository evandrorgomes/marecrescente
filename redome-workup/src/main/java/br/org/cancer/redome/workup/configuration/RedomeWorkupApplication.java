...
import br.org.cancer.redome.workup.service.impl.BluemixStorageService;

@SpringBootApplication(scanBasePackages = "br.org.cancer.redome.workup")
...
@EnableOAuth2Client
public class RedomeWorkupApplication extends SpringBootServletInitializer {
	...
	public static void main(String[] args) {
		SpringApplication.run(RedomeWorkupApplication.class, args);
	}
	...
	private static SpringApplicationBuilder configureApplication(SpringApplicationBuilder builder) {
		return builder.sources(RedomeWorkupApplication.class).web(WebApplicationType.SERVLET);
	}
