 ...
 */
@RestController
@RequestMapping(value = "/api/arquivopedidoworkup")
public class ArquivoPedidoWorkupController {
	...
	public void baixarArquivoStorage(
		...
		File arquivo = arquivoPedidoWorkupService.obterArquivoDoStorage(idArquivo);
