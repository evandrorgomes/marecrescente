...
public class PedidoAdicionalWorkupControllerAnalistaWorkupTest extends BaseConfigurationTest {
	
	@Value("classpath:arquivo_adicional_workup.pdf")
	...
	public void deveFinalizarPedidoAdicionalWorkupComSucesso() throws Exception {
		...
		makeStubForGet("/redome-tarefa/api/tarefas?filter=eyJwZXJmaWxSZXNwb25zYXZ" + 
				...
				"VmYVNlbUFnZW5kYW1lbnRvIjp0cnVlLCJpZFVzdWFyaW9Mb2dhZG8iOjl" + 
				"9",
	...
	@Test
	public void deveSalvarArquivoExameAdicionalDoStorageComSucesso() throws Exception {
				
		File file = resourceFile.getFile();
		FileInputStream in = new FileInputStream(file);
		MockMultipartFile mockMultipartFile = new MockMultipartFile("file", "arquivo_adicional_workup.pdf", "application/pdf", in);
		MockMultipartFile idPedidoAdicionalFile = new MockMultipartFile("idPedidoAdicional", null, "application/json", "1".getBytes());
		
		mockMvc
				.perform(CreateMockHttpServletRequest.makeMultipart("/api/pedidoadicionalworkup/arquivo",  "post")
				.file(idPedidoAdicionalFile)
