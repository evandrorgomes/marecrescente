...
@Profile("test")
@Configuration
@EnableJpaRepositories(basePackages = { "br.org.cancer.modred.persistence", "br.org.cancer.modred.redomelib.persistence" })
...
public class H2JpaConfig {
	...
	public EmbeddedDatabase dataSource() {
		EmbeddedDatabase dataSource = new EmbeddedDatabaseBuilder().
	            ...
	            addScript("h2/get_score.sql").
	            addScript("h2/valores_para_teste.sql").
	            build();
		...
		dataSource.setUrl("jdbc:h2:mem:testdb;Mode=Oraclenew HibernateJpaDialect()");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "br.org.cancer.modred.model" });
