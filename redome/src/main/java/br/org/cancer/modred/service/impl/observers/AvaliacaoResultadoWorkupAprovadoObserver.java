 ...
 */
@Component
public class AvaliacaoResultadoWorkupAprovadoObserver extends EntityObserver<AvaliacaoResultadoWorkup> {
	...
	public boolean condition(AvaliacaoResultadoWorkup avaliacaoResultado) {
		return Boolean.TRUE.equals(avaliacaoResultado.getSolicitaColeta());
	}
...
/*		final ResultadoWorkupDTO resultadoWorkup = avaliacaoResultado.getResultadoWorkup();
		...
		mensagem = AppUtil.getMensagem(messageSource, 
				doador.isNacional() ?
				"centro_transplantador.doador.notificacao.aprovacao_coleta_nacional" : "doador.internacional.notificacao.aprovacao_coleta", 
