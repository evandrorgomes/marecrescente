 ...
 * @param <T>
 */
public class UsuarioJsonPage  <T> extends org.springframework.data.domain.PageImpl<T>  {
     ...
     * @param total 
     */
    public UsuarioJsonPage(final List<T> content, final Pageable pageable, final long total) {
     ...
     * @param content
     */
    public UsuarioJsonPage(final List<T> content) {
        super(content);
    }
     ...
     * @param pageable
     */
    public UsuarioJsonPage(final Page<T> page, final Pageable pageable) {
