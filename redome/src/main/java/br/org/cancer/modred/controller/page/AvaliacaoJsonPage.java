 ...
 * @param <T>
 */
public class AvaliacaoJsonPage <T> extends org.springframework.data.domain.PageImpl<T> {
     ...
     * @param total
     */
    public AvaliacaoJsonPage(final List<T> content, final Pageable pageable, final long total) {
     ...
     * @param content
     */
    public AvaliacaoJsonPage(final List<T> content) {
        super(content);
    }
     ...
     * @param pageable
     */
    public AvaliacaoJsonPage(final Page<T> page, final Pageable pageable) {
