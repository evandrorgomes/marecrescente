...
/**
 * Classe de chave primária para split valor P.
 * 
 * @author brunosousa
 */
@Embeddable
public class SplitValorPPK implements Serializable {
	...
	@Column(name = "SPVP_TX_VALOR")
	private String valor;	
	
	@Column(name = "SPVP_TX_NOME_GRUPO")
	...
	public boolean equals(Object obj) {
		...
		SplitValorPPK other = (SplitValorPPK) obj;
		if (locus == null) {
			if (other.locus != null){
				return false;
			}
