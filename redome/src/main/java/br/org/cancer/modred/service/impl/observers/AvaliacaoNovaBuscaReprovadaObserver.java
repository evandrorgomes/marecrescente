 ...
 */
@Component
public class AvaliacaoNovaBuscaReprovadaObserver extends EntityObserver<AvaliacaoNovaBusca>{
	...
	protected boolean condition(AvaliacaoNovaBusca avaliacao) {
		return StatusAvaliacaoNovaBusca.REPROVADA.equals(avaliacao.getStatus());
	}
	...
	protected void process(AvaliacaoNovaBusca avaliacao) {
		...
		CategoriasNotificacao.AVALIACAO_NOVA_BUSCA.getConfiguracao()
			...
			.comDescricao(AppUtil.getMensagem(messageSource, "notificacao.nova.busca.reprovada.sucesso"))
			.apply();
	}
