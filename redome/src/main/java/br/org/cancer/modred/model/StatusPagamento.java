...
public class StatusPagamento implements Serializable {
	...
	private static final long serialVersionUID = -699251686554755534L;
	...
	/**
	 * Construtor recebendo o id do status de pagamento.
	 * @param id identifiação do status de pagamento.
	 */
