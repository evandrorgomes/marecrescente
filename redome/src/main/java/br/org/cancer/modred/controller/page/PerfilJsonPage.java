 ...
 * @param <T>
 */
public class PerfilJsonPage <T> extends org.springframework.data.domain.PageImpl<T>  {
     ...
     * @param total 
     */
    public PerfilJsonPage(final List<T> content, final Pageable pageable, final long total) {
     ...
     * @param content
     */
    public PerfilJsonPage(final List<T> content) {
        super(content);
    }
     ...
     * @param pageable
     */
    public PerfilJsonPage(final Page<T> page, final Pageable pageable) {
