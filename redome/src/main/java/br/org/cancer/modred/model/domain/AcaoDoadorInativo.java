 ...
 *
 */
public enum AcaoDoadorInativo implements EnumType<Long>{
    ATIVAR(0L),
    ANALISE_MEDICA(1L),
    MANTER_INATIVO(2L);
	 ...
	 */
	public static AcaoDoadorInativo valueById(Long value) {

		AcaoDoadorInativo[] values = AcaoDoadorInativo.values();
