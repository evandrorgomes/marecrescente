 ...
 * @param <T>
 */
public class TarefaJsonPage <T> extends org.springframework.data.domain.PageImpl<T> {

    /**
     * Identificador de versão de serialização da classe.
     */
    private static final long serialVersionUID = 3428668240849183967L;
     ...
     * @param total 
     */
    public TarefaJsonPage(final List<T> content, final Pageable pageable, final long total) {
     ...
     * @param content
     */
    public TarefaJsonPage(final List<T> content) {
        super(content);
    }
     ...
     * @param pageable
     */
    public TarefaJsonPage(final Page<T> page, final Pageable pageable) {
