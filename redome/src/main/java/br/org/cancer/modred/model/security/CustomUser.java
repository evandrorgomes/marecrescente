...
public class CustomUser extends User {
	...
	private Set<CentroTransplanteDto> centros;
	...
	public CustomUser(Usuario usuario, List<Permissao> permissoes, Set<String> recursos, Set<String> perfis,
		...
		if (centros != null) {
			...
			centros.forEach(centro -> {
				CentroTransplanteDto ct = new CentroTransplanteDto(centro.getId(), centro.getNome());				
				ct.getFuncoes().addAll(centro.getFuncoes());
				this.centros.add(ct);
			});
		}
	 ...
	 * @return the centros
	 */
	public Set<CentroTransplanteDto> getCentros() {
		return centros;
	}
	 ...
	 *            the centros to set
	 */
	public void setCentros(Set<CentroTransplanteDto> centros) {
		this.centros = centros;
	}
