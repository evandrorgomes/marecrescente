package br.org.cancer.modred.redomelib.persistence.impl;
...
/**
 * classe que implementa as chamadas ao banco. 
 * 
 * @author brunosousa
 *
 */
@Repository
@Transactional
public class IHlaRepositoryImpl implements IHlaRepository {
