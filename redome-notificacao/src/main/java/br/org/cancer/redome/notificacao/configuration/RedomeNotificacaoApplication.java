...
@EnableWebMvc
@EnableScheduling
@SpringBootApplication(scanBasePackages = "br.org.cancer.redome.notificacao")
//@EnableFeignClients(basePackages = {"br.org.cancer.redome.notificacao.feign"})
@EnableOAuth2Client
public class RedomeNotificacaoApplication  extends SpringBootServletInitializer{
	...
	public static void main(String[] args) {
		SpringApplication.run(RedomeNotificacaoApplication.class, args);		
	}
	...
	private static SpringApplicationBuilder configureApplication(SpringApplicationBuilder builder) {
		return builder.sources(RedomeNotificacaoApplication.class).web(WebApplicationType.SERVLET);
	}
