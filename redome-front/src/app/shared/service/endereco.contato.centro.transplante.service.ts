 ...
 */
@Injectable()
export class EnderecoContatoCentroTransplanteService extends BaseService{
     ...
     */
    atualizarEnderecoContato(id: number, enderecoContato: EnderecoContatoCentroTransplante): Promise<any> {
        return this.http.put(environment.endpoint + 'enderecoscontatoscentrotransplante/'+id, enderecoContato)
