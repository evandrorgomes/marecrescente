...
public class MakeAuthorizationForUser implements IAuthorizationForUser {
	...
	public List<String> resources  = Arrays.asList("modred_rest_api", "modred-rest-tarefa", "modred-rest-notificacao", "modred-rest-workup", "modred-rest-courier", "modred-rest-auth");
