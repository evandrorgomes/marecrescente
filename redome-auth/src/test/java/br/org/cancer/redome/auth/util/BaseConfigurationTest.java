...
import br.org.cancer.redome.auth.configuration.RedomeAuthApplication;
import br.org.cancer.redome.auth.util.authorization.MakeAuthotization;

@RunWith(SpringRunner.class)
@TestPropertySource(locations= {"classpath:bootstrap.yml", "classpath:application.yml", "classpath:application-test.yml"})
@ActiveProfiles("test")
@SpringBootTest(classes = {RedomeAuthApplication.class}, webEnvironment= WebEnvironment.DEFINED_PORT)
