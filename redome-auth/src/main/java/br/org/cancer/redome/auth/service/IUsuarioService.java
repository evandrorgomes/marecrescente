...
public interface IUsuarioService {
	...
	/**
	 * Obtém usuários com perfil de transportadora que não estão vinculados 
	 * a nenhuma transportadora.
	 * @return lista de usuários válidos para serem vinculados a uma transportadora.
	 */
	List<Usuario> listarUsuariosTransportadorasDisponiveis();
	...
	UsuarioDTO obterUsuarioDTO(Long id);

	/**
	 * Atribui a transportadora para os usuários com perfil de  transportadora que estejam disponíveis.
	 * 
	 * @param idTransportadora Identificação da transportadora.
	 * @param usuarios Lista de identificação dos usuários.
	 */
	void atribuirUsuariosParaTransportadora(Long idTransportadora, List<Long> usuarios);
