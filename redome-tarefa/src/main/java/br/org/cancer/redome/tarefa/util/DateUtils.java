...
import br.org.cancer.redome.tarefa.configuration.ApplicationContextProvider;
...
public class DateUtils {
	...
	public static LocalDate calcularDataNascimentoSimulada(Integer idade) {
    ...
    public static LocalDate converterParaLocalDate(String data) {
    	if(data != null) {
    		return LocalDate.parse(data, FORMATTER_YYYY_MM_DD);
    	}
    	return null;
    }
}