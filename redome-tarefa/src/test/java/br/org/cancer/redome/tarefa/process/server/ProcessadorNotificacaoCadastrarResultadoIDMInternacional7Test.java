...
public class ProcessadorNotificacaoCadastrarResultadoIDMInternacional7Test extends BaseConfigurationTest {

	
	@Autowired
	private ProcessadorNotificacaoCadastrarResultadoIDMInternacional7 processador;
	...
	public void deveProcessarTarefaComSucesso() {
		...
		Mockito.when(exameFeign.notificacarCadastroResultadoExameIdmInternacional7(Mockito.anyLong())).thenReturn(resultOk);
