...
public class ProcessadorNotificacaoCadastrarResultadoIDMInternacional15Test  extends BaseConfigurationTest {

	@Autowired
	private ProcessadorNotificacaoCadastrarResultadoIDMInternacional15 processador;
	...
	public void deveProcessarTarefaComSucesso() {
		...
		Mockito.when(exameFeign.notificacarCadastroResultadoExameIdmInternacional15(Mockito.anyLong())).thenReturn(resultOk);
