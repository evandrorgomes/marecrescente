...
public class ProcessadorNotificacaoCadastrarResultadoExameCtInternacional7Test extends BaseConfigurationTest {

	@Autowired
	private ProcessadorNotificacaoCadastrarResultadoExameCtInternacional7 processador;
	...
	public void deveProcessarTarefaComSucesso() {
		...
		Mockito.when(exameFeign.notificacarCadastroResultadoExameCtInternacional7(Mockito.anyLong())).thenReturn(resultOk);
