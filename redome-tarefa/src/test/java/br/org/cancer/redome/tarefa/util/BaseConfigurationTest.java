...
import br.org.cancer.redome.tarefa.configuration.EmptyStringDeserializer;
import br.org.cancer.redome.tarefa.configuration.RedomeTarefaApplication;
import br.org.cancer.redome.tarefa.util.authorization.MakeAuthotization;

@RunWith(SpringRunner.class)
@TestPropertySource(locations = {"classpath:application.yml", "classpath:application-test.yml"})
@ActiveProfiles("test")
@SpringBootTest(classes = {RedomeTarefaApplication.class}, webEnvironment= WebEnvironment.RANDOM_PORT)
