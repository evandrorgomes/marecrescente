...
import br.org.cancer.redome.courier.exception.FeignClientException;
import br.org.cancer.redome.courier.exception.ValidationException;
import br.org.cancer.redome.courier.util.ErroMensagem;
...
public class ExceptionHandlingController {
    ...
    public ResponseEntity<ErroMensagem> handlerValidationException(HttpServletRequest request,
        ...
        return ResponseEntity.status(HttpStatus.UNPROCESSABLE_ENTITY).header("content-type", "application/json;charset=UTF-8").body(erro);
    }
    ...
    @ResponseBody
    public ResponseEntity<Object> handleHystrixRuntimeException(HttpServletRequest request, Throwable exception) {
    ...
    public ResponseEntity<Object> handleFeignException(HttpServletRequest request, Throwable exception) {
    	FeignClientException exc = (FeignClientException)exception;
    	return ResponseEntity.status(exc.getStatus()).header("content-type", "text/plain;charset=UTF-8").body(exc.getMessage());
    }
